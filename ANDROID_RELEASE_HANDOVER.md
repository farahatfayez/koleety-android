...
تزيل نسخة السياسة `1.0.22` أذونات الوصول لوسائط وصور التخزين من غلاف Android فقط. اختيار صورة أو ملف محاضرة يبقى ضمن المتصفح Chrome بعد فتح TWA، ولا يعتمد على إذن قراءة الصور من الغلاف. لم يتغير عنوان TWA أو App Links أو المفتاح أو إعدادات الشبكة أو الكاميرا الاختيارية.
